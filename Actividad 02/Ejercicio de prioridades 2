...
/*El codigo envia un mensaje al ejecutarse que dice "UPIIZ", porque tiene prioridad por el número 1, luego se envía un "*" por UART 
El codigo imprime "UPIIZ" varias veces  y en algunos periodos imprime el "*" pero menos veces con el tiempo por su baja prioridad*/
