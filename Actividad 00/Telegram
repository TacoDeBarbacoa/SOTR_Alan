...
const char* ssid = "Error 404 Wi-Fi No Disponible";
const char* password = "notelavoyapasar";


#define BOTtoken "1579933792:KKDCpCpG3blpw8-0ztaDZwCHho4Ndzby-qt"  


#define CHAT_ID "1579933792"
