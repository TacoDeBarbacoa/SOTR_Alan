...
/*En este codigo utiliza timers, los cuales deben imprimen su mensaje al puerto serial. 
La actividad 2 lo que sucede es que al escribir en el puerto serial este reinicia el timer.*/
